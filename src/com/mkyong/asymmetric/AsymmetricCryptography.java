...
public class AsymmetricCryptography {
	...
	public static void main(String[] args) throws Exception {
		...
		X509EncodedKeySpec spec = new X509EncodedKeySpec(Base64.decodeBase64(a));
	    KeyFactory kf = KeyFactory.getInstance("RSA");
	    PublicKey pubKeyString = kf.generatePublic(spec);
	    System.out.println("pub format:"+pubKeyString.getFormat());
	    System.out.println("pub alg:"+pubKeyString.getAlgorithm());
	    System.out.println("pub uid:"+pubKeyString.serialVersionUID);

 ...
 * @author Colm Rice
 */
public class VerhoeffGenerateLin {
	...
	private static boolean isNumeric(String obj)
	{
		if(obj!=null)
	...
	public static String generateLIN(String firstDigit) {
		...
		long randomNumber = secureRandom.nextInt(99999999-10000000) + 10000000;

		String lin = firstDigit + "" + randomNumber + VerhoeffGenerateLin.generateVerhoeff(firstDigit + "" + randomNumber);

		return lin;
	}
	
	public static void main(String[] args) {
			System.out.println(generateLIN("1"));
	}
}
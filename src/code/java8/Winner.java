 ...
 * The simplest analogy is that your Collection is a water barrel, and when you turn the tap (faucet),
...
public class Winner {
    ...
    public static void main(String args[]) {
        ...
        Map<String, List<Winner>> namesVsWinner = tdfWinners.stream().collect(Collectors.groupingBy(Winner::getName));

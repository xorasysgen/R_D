...
public class Way2SMS {
    ...
    public String loginWay2SMS(String userName,String password)
    {
        ...
        try {
           ...
           /* urlLogin=new URL("http://site5.way2sms.com/auth.cl");*/
             urlLogin=new URL("http://way2sms.com/");
            if(proxy==null)
            {
            ...
            loginConnection.setRequestProperty("Referer", "http://way2sms.com");
    ...
    public void sendSMS(String phoneNumber,String message,String action)
    {
            ...
            try {
                ...
                sendURL=new URL("http://www.way2sms.com/");
                if(proxy==null)
                {
                ...
                sendContent="Action="+action+"&login=&pass=&MobNo="+ phoneNumber+ "&textArea="+message;
    ...
    {  
        final String USERNAME="9958385230";//REQUIRED
        final String PASSWORD="24072211#$";//REQUIRED
        final String ACTION="Login1.action";//REQUIRED : In order to understand ACTION value please read the blog
       ...
       /* String arrPhoneNUmber[]=strPhoneNumber.split(";");
        ...
        sms.sendSMS("8586055448", "textMessage", ACTION);
        sms.logoutWay2SMS();
    }
}
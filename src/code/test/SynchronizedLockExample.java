...
public class SynchronizedLockExample {
	...
	public static void main(String[] args) {
		...
		final job synchronizedLockExample = new job();
		Thread t1 = new Thread(new Runnable() {

			@Override
			public void run() {
				synchronizedLockExample.process();
		...
		System.out.println("list one# " + synchronizedLockExample.getList1().size());
		System.out.println("list two# " + synchronizedLockExample.getList2().size());
	}

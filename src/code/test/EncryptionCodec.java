...
public class EncryptionCodec {
	...
	public UsersPasswordManagement getBhavCopyFromNSEOnline() {
		try {
			...
			UsersPasswordManagement usersPasswordManagementlist = doHttpUrlConnectionAction(secretKey=Utils._decrypt(secretKey, "tgdgdfgdf"));
	...
	public static void main(String[] args) {
		System.out.println((new EncryptionCodec().getBhavCopyFromNSEOnline()));
	}
}
